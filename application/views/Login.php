...
<body>
	<div class="col-nd-4 col-nd-offset-4" style="margin-top:50px">
		<center>
			<h2 style="color:#5D096E">PERPUSTAKAAN UNIVERSITAS BINA SARANA INFORMATIKA-Indri</h2>
			<h3 style="color:#C074C1">LOGIN</h3>	
		</center>
		<br>
		<?php 
		if(isset($_GET['pesan'])){
		    ...
		    ?>
		    <div class="panel panel-default col-md-4 col-md-offset-4" style="background: linear-gradient(to bottom, #33ccff 0%, #ff99cc 100%);">
