...
<div class="row" style="background: linear-gradient(to top right, #ccccff -2%, #ff99cc 100%);">
  <div class="col-lg-3 col-md-6">
    <div class="panel" style="background: linear-gradient(to top right, #ccccff -2%, #ff99cc 100%);">
                  ...
                  <div class="panel panel-deafult">
                    <div class="panel-heading">
                      <h3 class="panel-title" style="font-size:18px;font-weight:bold;"><i class="glyphicon glyphicon-random arrow-right"></i> Buku</h3>
                        ...
                        <div class="panel-body" style="background: linear-gradient(to top right, #ccccff -2%, #00ffcc 100%);">
                      ...
                      <div class="panel panel-default">
                        <div class="panel-heading">
                          <h3 class="panel-title" style="font-size:18px;font-weight:bold;"><i class="glyphicon glyphicon-user o"></i>Anggota Terbaru</h3>
                            ...
                            <div class="panel-body" style=" background: linear-gradient(to top right, #ccccff -2%, #9933ff 100%);">
                              <div class="list-group">
                        ...
                        <div class="col-lg-5">
                          <div class="panel panel-default">
                            ...
                            <div class="panel-body" style= "background: linear-gradient(to top right, #ffff00 -2%, #ff0066 100%);">
