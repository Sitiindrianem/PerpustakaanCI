...
<a href="<?php echo base_url().'admin/tambah_peminjaman'; ?>" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-plus"></span> Transaksi Baru</a>
	...
	<div class="table-responsive">
		<table class="table table-bordered table-striped table-hover" id ="table-datatable" style="color:#6E0909">
			<thead>
			  <tr>
				<th>No</th>
				<th>Anggota</th>
		...
		<tbody>
		  ...
		  <tr>
			...
			<td>
				<?php
				if($p->status_buku == "Selesai"){ echo "Selesai";
				}else{ 
					echo "-";
					} ?>
			</td>
			<td>
				<?php
				if($p->status_peminjaman == "Selesai"){ echo "-";
				}else {
				?>
